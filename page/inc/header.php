...
h6 {
    ...
    <link href="http://localhost/Projet_classe/src/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="http://localhost/Projet_classe/src/css/sb-admin-2.min.css" rel="stylesheet">
    <link href="http://localhost/Projet_classe/src/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600&display=swap" rel="stylesheet">
    <script src="http://localhost/Projet_classe/src/js/bootstrap.js"></script>
    <script src="http://localhost/Projet_classe/src/js/bootstrap.bundle.js"></script>
    <script src="http://localhost/Projet_classe/src/js/bootstrap.esm.js"></script>
    <script src="http://localhost/Projet_classe/src/js/bootstrap.js.map"></script>
    <!-- particles.js -->
    ...
    <link href="http://localhost/Projet_classe/src2/css/styles.css" rel="stylesheet" />
    <script src="http://localhost/Projet_classe/src2/js/scripts.js"></script>
</head>
